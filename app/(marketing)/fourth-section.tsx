...
const tabs = [
  ...
  },
  {
    ...
    subheading:
      "Everything is customizable. Choose your own colors, icons, and more to make NoteWave work for you.",
  ...
  return (
    <>
      <div className="flex flex-col  pt-20 xl:py-32 items-center justify-center">
        ...
        >
          &quot;NoteWave adapts to your needs. It&apos;s as minimal or as powerful
        ...
        <div className="items-center flex justify-center flex-col">
          ...
          <div className="m text-center">
            <div className="text-sm  font-medium pt-4">Dhruv Sharma</div>
            <div className="text-sm">Owner, NoteWave Software</div>
          </div>
        </div>
      </div>
