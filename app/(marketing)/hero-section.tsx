...
const tabs = [
  {
    ...
    name: "Innovation",
    description: "Productivity for better faster work.",
    more: (
  ...
  },
  {
    ...
    name: "Docs",
    description: "Simple, powerful, beautiful. Next-gen notes.",
    more: (
  ...
  return (
    <div className="md:items-center flex flex-col ">
      <div
        ...
        "
      >
        Write, plan, share. With NoteWave at your side.
      </div>
      ...
      <p
        ...
        "
      >
        NoteWave is the connected workspace where better, faster work happens.
      </p>
      ...
      <div className="flex gap-4 pt-6 items-center justify-center">
          ...
          <Button className="py-1 ">
            <Link href="/documents">
              <div className="flex items-center justify-center">
                <div className="text-lg">Enter NoteWave</div>
                <div>
        ...
        {isClient && !isAuthenticated && !isLoading && (
          <SignInButton mode="modal">
            <Button className="py-1 ">
              <div className="flex items-center justify-center">
                <div className="text-lg">Get NoteWave Free</div>
                <div>
                  <PiArrowRight className="ml-2 " />
                </div>
              </div>
